...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js" integrity="sha384-aJ21OjlMXNL5UyIl/XNwTMqvzeRMZH2w8c5cRVpzpU8Y5bApTppSuUkhZXN0VxHd" crossorigin="anonymous"></script>
  ...
  <title>Login - <?php include('dist/includes/title.php');?></title>
    ...
    <!-- Bootstrap 3.3.5  <link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">-->
    ...
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load.   <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css"> -->
   
    <title>DOCTORPRJxxx IPS</title>
    <!-- meta tags -->
    <meta charset="UTF-8" />
