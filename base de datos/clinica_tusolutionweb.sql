...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-05-2020 a las 06:00:56
...
--
-- Base de datos: `clinica_tusolutionweb`
--
...
(1, 'clinica tusolutionweb', '4324', 'av san marino', '242432334', 'empresa clinica tusolutionweb', 'logo.jpg', 'tusolutionweb@gmail.com', '$./', 'nuevo sol');
...
(5, 'admin', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', '', 'administrador', 'tusolutionweb', 'tutos', '54345', 'tusolutionweb@gmail.com'),
...
--
ALTER TABLE `categoria_gastos`
  MODIFY `id_categoria` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `detalle_preescripcion`
  MODIFY `id_detalle_preescripcion` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `horario_medico`
  MODIFY `id_horario_medico` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `preescripcion`
  MODIFY `id_preescripcion` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `procedimiento_pago`
--
ALTER TABLE `procedimiento_pago`
  MODIFY `id_procedimiento_pago` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
