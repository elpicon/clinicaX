...
//encriptando contraseña
	$pass=md5($password);
		...
		///finzalizo encriptacion
				...
				mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono,correo,genero,eps_ars,ocupacion,fecha_nacimiento,tipo_sangre,direccion,grupo_empresa,edad,celular,ciudad,fecha_registro,toma_medicamentos,antecedentes,antecedentes_familiares)
			VALUES('$usuario','$pass','$img','$tipo','$nombre','$apellido','$telefono','$correo','','','','','','','','','','','$hoy','','','')")or die(mysqli_error($con));
	...
	//header('Location:../usuario.php');
		...
		$pass=$salt.$pass;
		    ...
		    mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono,correo,genero,eps_ars,ocupacion,fecha_nacimiento,tipo_sangre,direccion,grupo_empresa,edad,celular,ciudad,fecha_registro,toma_medicamentos,antecedentes,antecedentes_familiares)
			VALUES('$usuario','$pass','','$tipo','$nombre','$apellido','$telefono','$correo','','','','','','','','','','','$hoy','','','')")or die(mysqli_error($con));
