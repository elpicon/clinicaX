...
switch($accion){
        case 'agregar':
               $sentenciaSQL=$pdo->prepare("INSERT INTO eventos(title,descripcion,color,textColor,start,end,habil,idprofesional)
                                                          VALUES(:title,:descripcion,:color,:textColor,:start,:end,:habil,:idprofesional)");
        ...
        default:
                ...
                $sentenciaSQL=$pdo->prepare("SELECT * FROM eventos WHERE idprofesional='".$_REQUEST['idprofesional']."'");
