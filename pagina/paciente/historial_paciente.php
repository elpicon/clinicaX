    ...
    <div class="right_col" role="main">
      ...
      <!-- servicios-->
        ...
        <div class="col-lg-6 ">
          <div class="dropdown">
            ...
            <a tabindex="-1" href="#">Apoyo Diagnóstico</a>
      ...
      <div class="col-lg-6 ">
          <div class="text-right">
            <a type="button" class="btn btn-cama float-right"  onclick="limpiarT();limpiarTCups();" data-toggle="modal" data-target="#exampleModal">Plan de Manejo</a>
          </div>
        </div>
      ...
      <div class="row">
        <div class='col-lg-12  text-white menux colMenu' >
          <ul class="nav nav-tabs navBorde " id="myTab" role="tablist">
            ...
            <li class="nav-item  ">
              <a class="nav-link  btn-ver apartado1" id="rsistema-tab" data-toggle="tab" href="#rsistema" role="tab" aria-controls="rsistema" aria-selected="false"><span class="text-dark " >Revisión Sistema</span></a>
            </li>
            <li class="nav-item  ">
          ...
          <div class="tab-content tabPanel2">
            ...
            <div class="tab-pane active" id="datosconsulta" role="tabpanel" aria-labelledby="home-tab">
              ...
              <div class="row form-group">
                  <br>
                <div class="col-lg-12">
                <span  class=" text-left ">Causa externa consulta</span>
                <br>
                <br>
              ...
              <div class="row ">
                  <br>
                <div class="col-lg-12 form-group">
                  <span  class=" text-left ">Estado de conciencia *</span>
                  <br>
                <br>
              ...
              <div class="row ">
                <br>
                <div class="col-lg-12">
                    <span  class=" text-left ">Motivos de la consulta *</span>
                    <br>
                <br>
              ...
              <div class="row ">
                <br>
                <div class="col-lg-12">
                  <span  class=" text-left ">Enfermedad actual</span>
                  <br>
                <br>
              ...
              <div class="row ">
                <br>
                <div class="col-lg-12">
                  <span  class=" text-left ">Praclinicos</span>
                  <br>
                <br>
            ...
            <div class="tab-pane" id="antecedentes" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class="form-group row">
                <div class="col-xs-6">
                <span class=" subt" for="antc_ginecologicos">Ginecológicos</span>
                <br>
                <br>
                ...
                <span class="subt" for="antc_quirurgicos">Quirurgicos</span>
                <br>
                <br>
              ...
              <div class="form-group row">
                <div class="col-xs-6">
                <br>
                <span class="subt" for="antc_traumaticos">Traumaticos</span>
                <br>
                <br>
                ...
                <div class="col-xs-6">
                <br>
                <span class="subt" for="antc_transfusionales">Transfusionales</span>
                <br>
                <br>
              ...
              <button id="" onclick="vervars();" class="btn-cama btn">Ver</button>
            
              <div class="form-group row">
                <div class="col-xs-6">
                <br>
                  <span class=" subt" for="antc_alergicos">Alergias</span>
                ...
                <div class="col-xs-6">
                <br>
                  <span class="subt" for="antc_hospitalizaciones">Hospitalizaciones</span>
                  <br>
                <br>
              ...
              <div class="form-group row">
                <div class="col-xs-6">
                <br>
                <span class="subt" for="antc_patologicos">Patológicos</span>
                <br>
                <br>
                ...
                <div class="col-xs-6">
                <br>
                <span class="subt" for="antc_toxicologicos">Toxicológicos</span>
                <br>
                <br>
              ...
              <div class="form-group row">
                <div class="col-xs-6">
                <br>
                <span class="subt" for="antc_familiares">Familiares </span>
                <br>
                <br>
                ...
                <div class="col-xs-6">
                <br>
                <span class="subt" for="antc_farmacologicos">Farmacológicos</span>
                <br>
                <br>
            ...
            <div class="tab-pane" id="datospaciente" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class='row'>    
                <div class='col-lg-6 col-sm-6 form-group' > 
                  <span class="subt">Fecha ingreso *</span>
                  <br>
                <br>
                ...
                <div class='col-lg-6 col-sm-6 form-group'  style=" margin-top: 30px;"> 
                  <br>
                  <br>
                ...
                <div class="col-lg-12">
                  <br>
                    <span for="txt_motivo_ingreso">Motivo de ingreso:</span>
                    <br>
                <br>
                ...
                <div class="col-lg-12">
                  <br>
                  <div class="form">
                    <span for="txt_motivo_ingreso">Observación general:</span>
                    <br>
                <br>
            ...
            <div class="tab-pane" id="atenciontriage" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class="row">
                ...
                <div class="col-lg-3">  
                  <span for="inputsm">IMC (kg/m2)</span>
                  <br>
                <br>
                ...
                <div class="col-lg-3">  
                  <span for="inputsm">Frecuencia Cardiaca *</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
                ...
                <div class="col-lg-3">  
                  <span for="inputsm">Presion Arterial Sistole *</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
                ...
                <div class="col-lg-3">  
                  <br>
                  <span for="inputsm">Presion Arterial Diastole *</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
                ...
                <div class="col-lg-3">  
                <br>
                  <span for="inputsm">Talla (cms)</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
                ...
                <div class="col-lg-3">  
                <br>
                  <span for="inputsm">Frecuencia Respiratioria</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
                ...
                <div class="col-lg-3"> 
                <br> 
                  <span for="inputsm">Temperatura *</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
                ...
                <div class="col-lg-3"> 
                <br> 
                  <span for="inputsm">Saturacion de Oxigeno</span>
                  <br>
                <br>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                </div>
              ...
              <div class="row">
                ...
                <br> 
                  <span class="form-check-label" for="defaultCheck1">
                      <span>Paciente con sintomas respiratorios:</span>
                  </span>
                ...
                <br> 
                    <span class="form-check-label" for="defaultCheck1">
                      ...
                      <input type="radio" name="chk_pulsoRoI" value="1" id="cv" value="0" checked><span for="" style="
    margin-left: 5px; ">Regular</span> 
                      <input type="radio" name="chk_pulsoRoI" value="0" id="cv" value="0" ><span for="" style="
    margin-left: 5px;">Irregular</span> 
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6 form-group">
                      <br>
                    <span  class=" text-left">Antecedentes Relevantes :</span>
                    <br>
                <br>
                ...
                <div class="col-lg-6 form-group">
                  <br>
                  <span  class=" text-left">Conducta Tomada :</span>
                  <br>
                <br>
              ...
              <div class="row">
                <div class="col-lg-12 form-group alert alert-secondary ">
                    ...
                    <div class="row " > 
                      <div class="col-lg-2 bg-red" style=" margin-left: 20px;"> <input  type="radio" name="chk_prioridad" value="1" id="cv"  checked ><label class="labelPrioridad">  I-Resucitar </label> </div>

                      <div class="col-lg-2 bg-orange" style="margin-left: 20px;"><input class="bg-orange" type="radio" name="chk_prioridad" value="2" id="cv"  ><label class="labelPrioridad"> II-Emergencia </label> </div>

                      <div class="col-lg-2" style="background: purple; margin-left: 20px;"><input type="radio" name="chk_prioridad" class="bg-orange"  value="3" id="cv"  > <label class="labelPrioridad ">III-Urgente </label></div>

                      <div class="col-lg-2 bg-green" style="margin-left: 20px;"><input type="radio" name="chk_prioridad" value="4" id="cv"  ><label class=" labelPrioridad"> IV-Prioritaria </label></div>

                      <div class="col-lg-2 bg-blue" style="margin-left: 20px;"><input type="radio" name="chk_prioridad" value="6" id="cv"  ><label class="labelPrioridad "> V-No Urgente </label></div>
                    </div>
              ...
              <div class="row">
                <div class='col-lg-12 col-sm-12 form-group'> 
                      <span  class=" text-left ">Profecional Sugerido :</span>
                      <br>
                <br>
            ...
            <div class="tab-pane" id="orden_salida" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 form-group">
                  <span class=" tex
                  t-left ">Finalidad de la Consulta</span>
                </div>
                ...
                <br>
                <div class="col-lg-4 form-group">
                  <span class=" text-left">Causa Externa Consulta</span>    </div>
              ...
              <p><strong>Nota:</strong> Puedes buscar la patología por código o por la descripción</p>
              <div class="form-group">
                <div class='row'>
                  ...
                  <div class='col-lg-6 col-sm-6'> 
                      <input list="result4" id="in_cie104" value="" class="form-control">
                          <datalist id="result4" >
                          </datalist>
                  </div>
                  <div class='col-lg-6 col-sm-6 form-group'> 
                  <input size="30" type="text" id="diagprincipal4"  class="form-control" name="diagprincipal4" readonly> 
                  </div>
                </div>
                ...
                <div class='row'>
                  <div class='col-lg-12 form-group'>  
                    <br>
                  <span>Tipo diagnóstico principal</span>
                  <br>
                  </div> 
                  <div class='col-lg-6  form-group' > 
              ...
              <div class='row'>
                <div class='col-lg-12 col-sm-12'> 
                  <br>
                  <span>Diagnóstico secundario 1</span>
                  <br>
                  <br>
                </div>
                  
                <div class='col-lg-6 col-sm-6'> 
                          <input list="result5" id="in_cie105" value="" class="form-control">
                              <datalist id="result5" >
                              </datalist>
                </div>
                  ...
                  <div class='col-lg-6 col-sm-6'> 
                          ...
                          <input size="30" type="text" class="form-control" id="diagprincipal5" name="diagprincipal5" readonly> 
                  </div>
                  <br>
              </div>
              <br>
              <div class='row'>
                <div class='col-lg-12 col-sm-12'> 
                          ...
                          <span>Diagnóstico Secundario 2</span>
                          <br>
                  <br>
                      </div>
                ...
                <div class='col-lg-6 col-sm-6'> 
                        ...
                        <input list="result6" id="in_cie106" value="" class="form-control">
                            <datalist id="result6" >
                            </datalist>
                </div>
                ...
                <input size="30" type="text" id="diagprincipal6" class="form-control" name="diagprincipal6" readonly> 
                </div>
                <br>
              </div>
              <br><br>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                            <span class=" text-left">Destino de paciente</span>
                      </div>
                        
                      <div class="col-lg-8">
                          <select class="form-control">
                          <option value="alta">Alta de la atención</option>
                    ...
                    <div class="row">
                      <br>
                      <div class="col-lg-4">
                        <span class=" text-left">Condición salida</span>
                      </div>
                      <div class="col-lg-8">
            ...
            <div class="tab-pane" id="vigilancia_nutricional" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class='row alert alert-secondary'>
                    ...
                    <div class="col-lg-6 form-group ">
                          <span><span class=" text-left ">Programa SAN :</span></span>
                    </div>
                    <div class="col-lg-6 form-group ">
                          <select class="form-control">
                    ...
                    <div class="col-lg-6 form-group ">
                          <span><span class=" text-left ">Micronutrientes :</span></span>
                    </div>
                    <div class="col-lg-6 form-group ">
                    ...
                    <div class="col-lg-6 form-group ">
                          <span><span class=" text-left ">Ordena Complementos Nutricionales :</span></span>
                    </div>
                    <div class="col-lg-6 form-group ">
                    ...
                    <div class="col-lg-12 form-group ">
                        <textarea class="" type="text" id="cuales_complementos" value="" rows="5" style="width: 100%; height: 50px" placeholder="¿Cuáles?"> </textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 form-group " style="
                          padding-left: 20px;">
                          <br>
                        <span class=" text-left ">Educacion Nutricional:</span>
                      </div>
                      ...
                      <div class="col-lg-2 form-group ">
                      <br>
                      <span class="text-left">Actividad Física:</span>
                      </div>
            
                      <div class="col-lg-5 form-group " style="
                        padding-right: 20px;">

                      <select required class="form-control" style="
                      margin-top: 10px;">
                          <option value="">Seleccione</option>
              ...
              <div class='row alert alert-secondary'>
                  ...
                  <div class="col-lg-1 form-group ">
                      <span class=" text-left ">Gestación:</span>
                  </div>
                  ...
                  <div class="col-lg-2 form-group ">
                      <span class=" text-left ">Prematuro: </span>
                  </div>
                  <div class="col-lg-5 form-group ">
                      <input class="" type="radio" name="chk_prematuro"  value="1"> <span>SI</span>
                      <input class="" type="radio" name="chk_prematuro" checked  value="0"><span>NO</span>
                  </div>
                    <br>
                    <div class="col-lg-3 form-group " style="margin-left: -185px;">
                    <br>
                        <span class=" text-left ">Lactancia materna: </span>
                    </div>
                    <div class="col-lg-4 form-group ">
                    <br>
                    ...
                    <div class="col-lg-1 form-group ">
                    <br>
                      <span class=" text-left ">Dias: </span>
                    </div>
                    <div class="col-lg-2 form-group text-right">
                    <br>
            ...
            <div class="tab-pane" id="antecedentesf" role="tabpanel" aria-labelledby="profile-tab">
              ...
              <div class ='row'>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="form-check">
                      <label>
                        <input type="checkbox" name="check" > <span class="text-success label-text">Convulsiones</span>
                      </label> 
                    </div>
                    ...
                    <div class="form-check">
                      <label>
                        <input type="checkbox" name="check" > <span class="text-success label-text">Trastornos metabolismos lípidos</span>
                      </label> 
                    </div>
              ...
              <div class="col-md-6">
                ...
                <form>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                    <label for="exampleFormControlTextarea1">Otros antecedentes familiares</label>
            ...
            <div class="tab-pane" id="examenfisico" role="tabpanel" aria-labelledby="messages-tab">
              ...
              <div class="row">
                ...
                <div class="col-lg-3">  
                  <div class="form-group">
                  <span for="inputsm">Cintura (cm)</span>
                ...
                <br>
                  <div class="form-group">
                  <span for="inputsm">Talla (cm)*</span>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                  </div>
                </div>
                ...
                <br>
                  <div class="form-group">
                  <span for="inputsm">muñeca (cm)</span>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                  </div>
                </div>
                ...
                <br>  
                  <div class="form-group">
                  <span for="inputsm">Frecuencia cardiaca Fetal</span>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                  </div>
                </div>
                ...
                <br>
                  <div class="form-group">
                  <span for="inputsm">Perimetro cefalico</span>
                  <input class="form-control input-sm" id="inputsm" type="number" value="0" required>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="diagnostico" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class="form-group">
                <div class='row'>
                  ...
                  <div class='col-lg-6 col-sm-6'> 
                    <input list="result" id="in_cie10" value=""  class="form-control">
                          <datalist id="result" >
                          </datalist>
                  </div>
                  <div class='col-lg-6 col-sm-6'> 
                      <input size="30" type="text"  class="form-control" id="diagprincipal" name="diagprincipal" readonly> 
                  </div>
                </div>
                ...
                <div class='row'>
                  ...
                  <span>Diagnóstico Secundario 1</span>
                    ...
                    <br>
                  <div class='col-lg-6 col-sm-6'> 
                          <input list="result2" id="in_cie102" value="" 
                          class="form-control">
                              <datalist id="result2" >
                              </datalist>
                  </div>
                  ...
                  <div class='col-lg-6 col-sm-6'> 
                          <input  class="form-control" size="30" type="text" id="diagprincipal2" name="diagprincipal2" readonly> 
                  </div>
                <br>
                </div>
                <br>
                ...
                <div class='row'>
                  <div class='col-lg-12 col-sm-12'> 
                        ...
                        <br>
                  <div class='col-lg-6 col-sm-6'> 
                    <input list="result3" id="in_cie103" value="" class="form-control">
                          <datalist id="result3" >
                          </datalist>
                  </div>
                  <div class='col-lg-6 col-sm-6'> 
                    <input size="30"  class="form-control" type="text" id="diagprincipal3" name="diagprincipal3" readonly> 
                  </div>
                  <br>
                </div>
                  <br><br>
                <div class='row'>
                  <div class="col-lg-12">
                    <div class="form">
                      <span>Diagnóstico Médico</span><br><br>
            ...
            <div class="tab-pane" id="resumenservicio" role="tabpanel" aria-labelledby="settings-tab">
              ...
              <div class='row'>
                ...
                <div class='col-lg-6 col-sm-6'> 
                  <input list="result" id="in_profesional_r" value="" class="form-control">
                  <datalist id="result" >
                  </datalist>
                </div>
                <div class='col-lg-6 col-sm-6'> 
                <input size="30" type="text" id="profesional_r" class="form-control" name="profesional_r"> 
                </div>
              </div>
              ...
              <div class='col-lg-12'>  
                <br>
                  ...
                  <div class='col-lg-6 col-sm-6'> 
                  <input list="registroprof" id="in_registradoPor" value="" class="form-control">
                  <datalist id="result" >
                  </datalist>
                  </div>
                  <div class='col-lg-6 col-sm-6'> 
                  <input size="30" type="text" id="registrado_por" class="form-control" name="registrado_por"> 
                  </div>
                </div>   
            </div>
