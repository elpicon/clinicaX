...
<div class="form-group row">
 ...
 <div class="tab-pane" id="atenciontriage" role="tabpanel" aria-labelledby="settings-tab">
    ...
    <span>Fecha del Triage *:</span>
        <input  type="date" id="facha_triage" name="fecha_trieage" class="form-control"> </input>
    </div> 
   ...
   <div class="col-lg-3">  
    ...
    <span class="form-check-label" for="defaultCheck1">
     ...
     <input type="checkbox" name="chk_vivo" value="1" id="cv" value="1"  onclick="ocultar('desc_respiratorio')"></input>
   </div>
   </div>
  ...
  <div class="col-lg-12">
       <span class="form-check-label" for="defaultCheck1">
        ...
        <input type="radio" name="chk_pulsoRoI" value="1" id="cv" value="0" checked> Regular </input>
        <input type="radio" name="chk_pulsoRoI" value="0" id="cv" value="0" > Irregular </input>
  </div>
   ...
   <label  class=" text-left">Conducta Tomada :</label>
    ...
    <div class="col-lg-12 form-group alert alert-secondary ">
        ...
        <div class="row " > 
          <div class="col-lg-4"> <input  type="radio" name="chk_prioridad" value="1" id="cv"  checked ><label class="bg-red">  I-Resucitar </label> </input></div>
           <div class="col-lg-4"><input class="bg-orange" type="radio" name="chk_prioridad" value="2" id="cv"  ><label class="bg-orange"> II-Emergencia </label> </input></div>
           <div class="col-lg-4"><input type="radio" name="chk_prioridad" value="3" id="cv"  > <label class="bg-warning ">III-Urgente </label></input></div>
           <div class="col-lg-4"><input type="radio" name="chk_prioridad" value="4" id="cv"  ><label class="bg-green "> IV-Prioritaria </label></input></div>
           <div class="col-lg-4"><input type="radio" name="chk_prioridad" value="6" id="cv"  ><label class="bg-blue "> V-No Urgente </label></input></div>
        </div>
...
<br>
        ...
        <div class='col-lg-6 col-sm-6'> 
                <input size="30" type="text" id="diagprincipal5" name="diagprincipal5" readonly> </input>
        </div>
<br>
</div>
<br>
    ...
    <div class='col-lg-6 col-sm-6'> 
    <input size="30" type="text" id="diagprincipal6" name="diagprincipal6" readonly> </input>
    </div>
    <br>
    </div>
<br><br>
 ...
 <span><label class=" text-left">Condicion de Salida</label></span>
   ...
   <select  class="form-control">
       ...
       <option value="muerto">Fallecido(a)</option>
        ...
        <div class='col-lg-6 form-group'>  
            <input class="chk" type="checkbox" id="chk_discapacitado"><span> Discapacitado</span> </input>
        </div> 
         <div class='col-lg-6 form-group'>  
            <input class="chk" type="checkbox" id="chk_fugado"><span> Fugado</span></input>
        </div> 
...
// source.addEventListener('change', inputHandler); 
 ...
 <div class="tab-pane" id="vigilancia_nutricional" role="tabpanel" aria-labelledby="settings-tab">
    ...
    <div class='row alert alert-secondary'>
         ...
         <div class="col-lg-6 form-group ">
            <input class="" type="radio" name="complementos_nutri"  onclick="mostrarArea()" value="1"> SI</input>
            <input class="" type="radio" name="complementos_nutri" checked onclick="ocultarArea()" value="0"> NO</input>
         </div>
         ...
         <div class="col-lg-6 form-group ">
            <input class="" type="radio" name="educacion_nutri" value="1"> SI</input>
            <input class="" type="radio" name="educacion_nutri" value="0" checked> NO</input>
         </div>
          <div class="col-lg-6 form-group ">
